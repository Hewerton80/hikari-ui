...
export declare const Alert: import("@stitches/core/types/styled-component").CssComponent<"div", import("@stitches/core/types/styled-component").StyledComponentProps<["div", {
    display: string;
    alignItems: string;
    text: string;
    px: string;
