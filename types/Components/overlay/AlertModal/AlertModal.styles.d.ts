...
export declare const alertCss: CSS;
export declare const Content: import("@stitches/core/types/styled-component").CssComponent<"div", {}, {
...
export declare const Icon: import("@stitches/core/types/styled-component").CssComponent<"svg", import("@stitches/core/types/styled-component").StyledComponentProps<["svg", {
    display: string;
    animation: string;
    text: string;
    variants: {
        variant: VariantsStylesMap;
    };
}]>, {
    bpBase: `(min-width: ${number}px)`;
    bpSm: `(min-width: ${number}px)`;
...
export declare const Title: import("@stitches/core/types/styled-component").CssComponent<"div", import("@stitches/core/types/styled-component").StyledComponentProps<["div", {
    text: string;
    textAlign: string;
    variants: {
        variant: VariantsStylesMap;
