...
export declare const Badge: import("@stitches/core/types/styled-component").CssComponent<"span", import("@stitches/core/types/styled-component").StyledComponentProps<["span", {
    display: string;
    alignItems: string;
